...
public class CrashPromptDialog {
    ...
    public static CrashPromptDialog create(Activity activity, n nVar, final AlwaysSendCallback alwaysSendCallback) {
        final OptInLatch optInLatch = new OptInLatch();
        DialogStringResolver dialogStringResolver = new DialogStringResolver(activity, nVar);
