...
public class ConstraintLayout extends ViewGroup {
    ...
    public ArrayList<b> f157f = new ArrayList<>(4);

    /* renamed from: g  reason: collision with root package name */
    public final ArrayList<d> f158g = new ArrayList<>(100);

    /* renamed from: h  reason: collision with root package name */
    public e f159h = new e();
    ...
    public int f162k = Integer.MAX_VALUE;

    /* renamed from: l  reason: collision with root package name */
    public int f163l = Integer.MAX_VALUE;

    /* renamed from: m  reason: collision with root package name */
    public boolean f164m = true;
    ...
    public HashMap<String, Integer> f168q = new HashMap<>();
    public int r = -1;
    public int s = -1;
    ...
    public void a(int i2, Object obj, Object obj2) {
        if (i2 == 0 && (obj instanceof String) && (obj2 instanceof Integer)) {
            ...
            this.f168q.put(str, Integer.valueOf(((Integer) obj2).intValue()));
        }
    }
    ...
    public final void b(int r24, int r25) {
        ...
        L_0x00d8:
            ...
            goto L_0x029d
        L_0x00e8:
            h.f.a.h.c$c r11 = h.f.a.h.c.C0042c.LEFT
            h.f.a.h.c r11 = r14.a((h.f.a.h.c.C0042c) r11)
            h.f.a.h.j r11 = r11.a
            h.f.a.h.c$c r9 = h.f.a.h.c.C0042c.RIGHT
            h.f.a.h.c r9 = r14.a((h.f.a.h.c.C0042c) r9)
            h.f.a.h.j r9 = r9.a
            h.f.a.h.c$c r10 = h.f.a.h.c.C0042c.LEFT
            h.f.a.h.c r10 = r14.a((h.f.a.h.c.C0042c) r10)
            h.f.a.h.c r10 = r10.d
            if (r10 == 0) goto L_0x010e
            h.f.a.h.c$c r10 = h.f.a.h.c.C0042c.RIGHT
            h.f.a.h.c r10 = r14.a((h.f.a.h.c.C0042c) r10)
            h.f.a.h.c r10 = r10.d
            if (r10 == 0) goto L_0x010e
            r10 = 1
        ...
        L_0x010e:
            r10 = 0
        L_0x010f:
            h.f.a.h.c$c r6 = h.f.a.h.c.C0042c.TOP
            h.f.a.h.c r6 = r14.a((h.f.a.h.c.C0042c) r6)
            h.f.a.h.j r6 = r6.a
            r18 = r3
            h.f.a.h.c$c r3 = h.f.a.h.c.C0042c.BOTTOM
            h.f.a.h.c r3 = r14.a((h.f.a.h.c.C0042c) r3)
            h.f.a.h.j r3 = r3.a
            r19 = r7
            h.f.a.h.c$c r7 = h.f.a.h.c.C0042c.TOP
            h.f.a.h.c r7 = r14.a((h.f.a.h.c.C0042c) r7)
            h.f.a.h.c r7 = r7.d
            if (r7 == 0) goto L_0x0139
            h.f.a.h.c$c r7 = h.f.a.h.c.C0042c.BOTTOM
            h.f.a.h.c r7 = r14.a((h.f.a.h.c.C0042c) r7)
            h.f.a.h.c r7 = r7.d
            if (r7 == 0) goto L_0x0139
            r7 = 1
        ...
        L_0x0144:
            r20 = r13
            h.f.a.h.e r13 = r0.f159h
            h.f.a.h.d$a r13 = r13.e()
            r21 = r12
            h.f.a.h.d$a r12 = h.f.a.h.d.a.WRAP_CONTENT
        ...
        L_0x0155:
            h.f.a.h.e r13 = r0.f159h
            h.f.a.h.d$a r13 = r13.h()
            h.f.a.h.d$a r0 = h.f.a.h.d.a.WRAP_CONTENT
    ...
    public void onLayout(boolean z, int i2, int i3, int i4, int i5) {
        ...
        for (int i7 = 0; i7 < childCount; i7++) {
            ...
            if ((childAt.getVisibility() != 8 || aVar.X || aVar.Y || isInEditMode) && !aVar.Z) {
                ...
                int i10 = dVar.i() + i8;
                int d = dVar.d() + i9;
                childAt.layout(i8, i9, i10, d);
                if ((childAt instanceof h.f.b.e) && (content = ((h.f.b.e) childAt).getContent()) != null) {
                    content.setVisibility(0);
                    content.layout(i8, i9, i10, d);
                }
            }
        }
        int size = this.f157f.size();
        if (size > 0) {
            while (i6 < size) {
                if (this.f157f.get(i6) != null) {
                    i6++;
                } else {
                    throw null;
                }
    ...
    public void onMeasure(int r40, int r41) {
        ...
        L_0x003c:
            ...
            int r17 = r17 + r15
            h.f.a.h.d$a r15 = h.f.a.h.d.a.FIXED
            r39.getLayoutParams()
        ...
        L_0x0073:
            ...
            goto L_0x0083
        L_0x007d:
            h.f.a.h.d$a r9 = h.f.a.h.d.a.WRAP_CONTENT
        L_0x007f:
            r10 = 0
            goto L_0x0083
        L_0x0081:
        ...
        L_0x008a:
            ...
            goto L_0x009a
        L_0x0093:
            h.f.a.h.d$a r11 = h.f.a.h.d.a.WRAP_CONTENT
            r15 = r11
        L_0x0096:
            r14 = 0
            goto L_0x009a
        L_0x0098:
            h.f.a.h.d$a r15 = h.f.a.h.d.a.WRAP_CONTENT
        L_0x009a:
            h.f.a.h.e r11 = r0.f159h
            r12 = 0
            r11.R = r12
            r11.S = r12
            r11.a((h.f.a.h.d.a) r9)
            h.f.a.h.e r9 = r0.f159h
            r9.f(r10)
            h.f.a.h.e r9 = r0.f159h
            r9.b((h.f.a.h.d.a) r15)
            h.f.a.h.e r9 = r0.f159h
            r9.e(r14)
            h.f.a.h.e r9 = r0.f159h
            int r10 = r0.f160i
        ...
        L_0x00df:
            h.f.a.h.e r9 = r0.f159h
            int r9 = r9.i()
            h.f.a.h.e r10 = r0.f159h
            int r10 = r10.d()
            boolean r11 = r0.f164m
        ...
        L_0x0109:
            ...
            java.util.ArrayList<h.f.a.h.d> r11 = r0.f158g
            r11.clear()
        ...
        L_0x0148:
            ...
            h.f.a.h.d r2 = r0.a((int) r2)     // Catch:{ NotFoundException -> 0x0152 }
        ...
        L_0x0158:
            ...
            h.f.a.h.d r12 = r0.a((android.view.View) r12)
        ...
        L_0x0171:
            ...
            boolean r14 = r12 instanceof h.f.b.d
            if (r14 == 0) goto L_0x018b
            h.f.b.d r12 = (h.f.b.d) r12
            h.f.b.c r12 = r12.getConstraintSet()
            r0.f166o = r12
        L_0x018b:
            int r2 = r2 + 1
            goto L_0x0171
        L_0x018e:
            ...
            java.util.HashMap<java.lang.Integer, h.f.b.c$a> r15 = r2.a
        ...
        L_0x01a2:
            ...
            java.util.HashMap<java.lang.Integer, h.f.b.c$a> r7 = r2.a
            r21 = r8
            ...
            h.f.b.c$a r7 = (h.f.b.c.a) r7
            boolean r8 = r12 instanceof h.f.b.a
        ...
        L_0x0298:
            ...
            java.util.HashMap<java.lang.Integer, h.f.b.c$a> r6 = r2.a
            java.lang.Object r6 = r6.get(r5)
            h.f.b.c$a r6 = (h.f.b.c.a) r6
            int r7 = r6.t0
            r8 = -1
        ...
        L_0x02ec:
            ...
            androidx.constraintlayout.widget.Guideline r7 = new androidx.constraintlayout.widget.Guideline
            android.content.Context r8 = r39.getContext()
            r7.<init>(r8)
            int r5 = r5.intValue()
            r7.setId(r5)
        ...
        L_0x030b:
            ...
            r21 = r8
        L_0x0313:
            h.f.a.h.e r1 = r0.f159h
            java.util.ArrayList<h.f.a.h.d> r1 = r1.k0
            r1.clear()
            java.util.ArrayList<h.f.b.b> r1 = r0.f157f
            int r1 = r1.size()
            if (r1 <= 0) goto L_0x0333
            r2 = 0
        L_0x0323:
            if (r2 >= r1) goto L_0x0333
            java.util.ArrayList<h.f.b.b> r5 = r0.f157f
            java.lang.Object r5 = r5.get(r2)
            h.f.b.b r5 = (h.f.b.b) r5
        ...
        L_0x0334:
            ...
            boolean r5 = r2 instanceof h.f.b.e
            if (r5 == 0) goto L_0x036c
            h.f.b.e r2 = (h.f.b.e) r2
            int r5 = r2.e
            r6 = -1
        ...
        L_0x0350:
            ...
            r6 = 1
            r5.Z = r6
            android.view.View r5 = r2.f1698f
            r6 = 0
            r5.setVisibility(r6)
            r2.setVisibility(r6)
        L_0x036c:
        ...
        L_0x0370:
            ...
            android.view.View r2 = r0.getChildAt(r1)
            h.f.a.h.d r5 = r0.a((android.view.View) r2)
        ...
        L_0x038f:
            ...
            int r8 = r2.getId()     // Catch:{ NotFoundException -> 0x03c0 }
            h.f.a.h.d r8 = r0.a((int) r8)     // Catch:{ NotFoundException -> 0x03c0 }
        ...
        L_0x03cf:
            r5.X = r2
            h.f.a.h.e r2 = r0.f159h
            java.util.ArrayList<h.f.a.h.d> r7 = r2.k0
            r7.add(r5)
            h.f.a.h.d r7 = r5.D
            if (r7 == 0) goto L_0x03e6
            h.f.a.h.n r7 = (h.f.a.h.n) r7
            java.util.ArrayList<h.f.a.h.d> r7 = r7.k0
            r7.remove(r5)
            r7 = 0
            r5.D = r7
        L_0x03e6:
        ...
        L_0x03f0:
            java.util.ArrayList<h.f.a.h.d> r2 = r0.f158g
            r2.add(r5)
        L_0x03f5:
            boolean r2 = r6.X
            if (r2 == 0) goto L_0x0429
            h.f.a.h.g r5 = (h.f.a.h.g) r5
            int r2 = r6.h0
            int r7 = r6.i0
            float r6 = r6.j0
        ...
        L_0x047b:
            ...
            h.f.a.h.d r26 = r0.a((int) r4)
            if (r26 == 0) goto L_0x05f0
            float r2 = r6.f179o
            int r3 = r6.f178n
            h.f.a.h.c$c r27 = h.f.a.h.c.C0042c.CENTER
            r29 = 0
            r24 = r5
            r25 = r27
            r28 = r3
        ...
        L_0x04af:
            ...
            h.f.a.h.d r26 = r0.a((int) r2)
            if (r26 == 0) goto L_0x04c6
            h.f.a.h.c$c r27 = h.f.a.h.c.C0042c.LEFT
        ...
        L_0x04c8:
            ...
            h.f.a.h.d r26 = r0.a((int) r7)
            if (r26 == 0) goto L_0x04c6
            h.f.a.h.c$c r25 = h.f.a.h.c.C0042c.LEFT
            h.f.a.h.c$c r27 = h.f.a.h.c.C0042c.RIGHT
            int r2 = r6.leftMargin
            r24 = r5
            r28 = r2
            r29 = r14
        ...
        L_0x04e1:
            ...
            h.f.a.h.d r26 = r0.a((int) r8)
            if (r26 == 0) goto L_0x0510
            h.f.a.h.c$c r25 = h.f.a.h.c.C0042c.RIGHT
            h.f.a.h.c$c r27 = h.f.a.h.c.C0042c.LEFT
        ...
        L_0x0510:
            ...
            h.f.a.h.c$c r27 = h.f.a.h.c.C0042c.TOP
            int r2 = r6.topMargin
            int r3 = r6.u
            r24 = r5
            r25 = r27
        ...
        L_0x052d:
            ...
            h.f.a.h.d r26 = r0.a((int) r2)
            if (r26 == 0) goto L_0x0549
            h.f.a.h.c$c r25 = h.f.a.h.c.C0042c.TOP
            h.f.a.h.c$c r27 = h.f.a.h.c.C0042c.BOTTOM
            int r2 = r6.topMargin
            int r3 = r6.u
            r24 = r5
            r28 = r2
        ...
        L_0x0549:
            ...
            h.f.a.h.c$c r25 = h.f.a.h.c.C0042c.BOTTOM
            h.f.a.h.c$c r27 = h.f.a.h.c.C0042c.TOP
        ...
        L_0x0582:
            ...
            android.util.SparseArray<android.view.View> r3 = r0.e
            java.lang.Object r2 = r3.get(r2)
            android.view.View r2 = (android.view.View) r2
            int r3 = r6.f176l
            h.f.a.h.d r3 = r0.a((int) r3)
            ...
            h.f.a.h.c r32 = r5.a((h.f.a.h.c.C0042c) r2)
            h.f.a.h.c$c r2 = h.f.a.h.c.C0042c.BASELINE
            h.f.a.h.c r33 = r3.a((h.f.a.h.c.C0042c) r2)
            r34 = 0
            r35 = -1
            h.f.a.h.c$b r36 = h.f.a.h.c.b.STRONG
            r37 = 0
            r38 = 1
            r32.a(r33, r34, r35, r36, r37, r38)
            h.f.a.h.c$c r2 = h.f.a.h.c.C0042c.TOP
            h.f.a.h.c r2 = r5.a((h.f.a.h.c.C0042c) r2)
            r2.c()
        ...
        L_0x0603:
            ...
            h.f.a.h.d$a r2 = h.f.a.h.d.a.MATCH_PARENT
            r5.a((h.f.a.h.d.a) r2)
        ...
        L_0x0626:
            ...
            goto L_0x063a
        L_0x0630:
            h.f.a.h.d$a r2 = h.f.a.h.d.a.FIXED
            r5.a((h.f.a.h.d.a) r2)
            int r2 = r6.width
            r5.f(r2)
        L_0x063a:
        ...
        L_0x0788:
            ...
            r4 = 0
            r3 = r3[r4]
            h.f.a.h.d$a r4 = h.f.a.h.d.a.WRAP_CONTENT
        ...
        L_0x07c2:
            ...
            boolean r5 = r4 instanceof h.f.b.e
            if (r5 == 0) goto L_0x0800
            h.f.b.e r4 = (h.f.b.e) r4
            android.view.View r5 = r4.f1698f
            if (r5 != 0) goto L_0x07d3
            goto L_0x0800
        L_0x07d3:
            android.view.ViewGroup$LayoutParams r5 = r4.getLayoutParams()
            androidx.constraintlayout.widget.ConstraintLayout$a r5 = (androidx.constraintlayout.widget.ConstraintLayout.a) r5
            android.view.View r4 = r4.f1698f
        ...
        L_0x0800:
            ...
            goto L_0x07c2
        L_0x0803:
            java.util.ArrayList<h.f.b.b> r2 = r0.f157f
            int r2 = r2.size()
            if (r2 <= 0) goto L_0x081d
            r3 = 0
        L_0x080c:
            if (r3 >= r2) goto L_0x081d
            java.util.ArrayList<h.f.b.b> r4 = r0.f157f
            java.lang.Object r4 = r4.get(r3)
            h.f.b.b r4 = (h.f.b.b) r4
        ...
        L_0x0843:
            h.f.a.h.e r1 = r0.f159h
            h.f.a.h.d$a r3 = h.f.a.h.d.a.FIXED
            r1.a((h.f.a.h.d.a) r3)
            goto L_0x0852
        L_0x084b:
            r4 = r30
        ...
        L_0x0867:
            h.f.a.h.e r1 = r0.f159h
            h.f.a.h.d$a r5 = h.f.a.h.d.a.FIXED
            r1.b((h.f.a.h.d.a) r5)
            goto L_0x087f
        L_0x086f:
            r6 = r22
        ...
        L_0x087f:
            ...
            h.f.a.h.e r2 = r0.f159h
            java.util.List<h.f.a.h.f> r2 = r2.w0
            r8 = 0
            g.a.a.b.a.a((java.util.List<h.f.a.h.f>) r2, (int) r8, (int) r1)
            goto L_0x08a5
        L_0x08a3:
            r7 = 1073741824(0x40000000, float:2.0)
        L_0x08a5:
            ...
            h.f.a.h.e r1 = r0.f159h
            java.util.List<h.f.a.h.f> r1 = r1.w0
            r2 = 1
            g.a.a.b.a.a((java.util.List<h.f.a.h.f>) r1, (int) r2, (int) r5)
        L_0x08b3:
            h.f.a.h.e r1 = r0.f159h
            boolean r2 = r1.y0
            ...
            java.util.List<h.f.a.h.f> r1 = r1.w0
            r2 = 0
            g.a.a.b.a.a((java.util.List<h.f.a.h.f>) r1, (int) r2, (int) r4)
            goto L_0x08c5
        L_0x08c4:
            r2 = 0
        L_0x08c5:
            ...
            java.util.List<h.f.a.h.f> r1 = r1.w0
            r3 = 1
            g.a.a.b.a.a((java.util.List<h.f.a.h.f>) r1, (int) r3, (int) r6)
            goto L_0x08d8
        L_0x08d6:
            r2 = 0
        L_0x08d7:
        ...
        L_0x08d8:
            ...
            r1.o()
        L_0x08e3:
            java.util.ArrayList<h.f.a.h.d> r1 = r0.f158g
            int r1 = r1.size()
            ...
            h.f.a.h.e r6 = r0.f159h
            h.f.a.h.d$a r6 = r6.e()
            h.f.a.h.d$a r7 = h.f.a.h.d.a.WRAP_CONTENT
        ...
        L_0x0904:
            h.f.a.h.e r7 = r0.f159h
            h.f.a.h.d$a r7 = r7.h()
            h.f.a.h.d$a r8 = h.f.a.h.d.a.WRAP_CONTENT
        ...
        L_0x09d8:
            ...
            h.f.a.h.c$c r10 = h.f.a.h.c.C0042c.RIGHT
            h.f.a.h.c r10 = r2.a((h.f.a.h.c.C0042c) r10)
            int r10 = r10.a()
            int r10 = r10 + r5
        ...
        L_0x0a03:
            ...
            int r5 = r2.c()
            h.f.a.h.c$c r9 = h.f.a.h.c.C0042c.BOTTOM
            h.f.a.h.c r9 = r2.a((h.f.a.h.c.C0042c) r9)
            int r9 = r9.a()
            int r9 = r9 + r5
    ...
    public void onViewRemoved(View view) {
        ...
        d a2 = a(view);
        this.f159h.k0.remove(a2);
        a2.D = null;
        this.f157f.remove(view);
        this.f158g.remove(a2);
        this.f164m = true;
    }
    ...
    public Object a(int i2, Object obj) {
        ...
        String str = (String) obj;
        HashMap<String, Integer> hashMap = this.f168q;
        if (hashMap == null || !hashMap.containsKey(str)) {
            return null;
        }
        return this.f168q.get(str);
    }
    ...
    public final void a(AttributeSet attributeSet) {
        ...
        if (attributeSet != null) {
            TypedArray obtainStyledAttributes = getContext().obtainStyledAttributes(attributeSet, h.f.b.g.ConstraintLayout_Layout);
            int indexCount = obtainStyledAttributes.getIndexCount();
            for (int i2 = 0; i2 < indexCount; i2++) {
                int index = obtainStyledAttributes.getIndex(i2);
                if (index == h.f.b.g.ConstraintLayout_Layout_android_minWidth) {
                    this.f160i = obtainStyledAttributes.getDimensionPixelOffset(index, this.f160i);
                } else if (index == h.f.b.g.ConstraintLayout_Layout_android_minHeight) {
                    this.f161j = obtainStyledAttributes.getDimensionPixelOffset(index, this.f161j);
                } else if (index == h.f.b.g.ConstraintLayout_Layout_android_maxWidth) {
                    this.f162k = obtainStyledAttributes.getDimensionPixelOffset(index, this.f162k);
                } else if (index == h.f.b.g.ConstraintLayout_Layout_android_maxHeight) {
                    this.f163l = obtainStyledAttributes.getDimensionPixelOffset(index, this.f163l);
                } else if (index == h.f.b.g.ConstraintLayout_Layout_layout_optimizationLevel) {
                    this.f165n = obtainStyledAttributes.getInt(index, this.f165n);
                } else if (index == h.f.b.g.ConstraintLayout_Layout_constraintSet) {
                    ...
                    this.f167p = resourceId;
                }
            }
            obtainStyledAttributes.recycle();
        }
        this.f159h.C0 = this.f165n;
    }
        ...
        for (int i8 = 0; i8 < childCount; i8++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (!aVar.X && !aVar.Y) {
                    ...
                    boolean z2 = aVar.U;
                    boolean z3 = true;
                    if (z2 || aVar.V || (!z2 && aVar.H == 1) || aVar.width == -1 || (!aVar.V && (aVar.I == 1 || aVar.height == -1))) {
                        if (i9 == 0) {
    ...
    public static class a extends ViewGroup.MarginLayoutParams {
        ...
        public static class C0000a {
            ...
            static {
                ...
                a = sparseIntArray;
                sparseIntArray.append(h.f.b.g.ConstraintLayout_Layout_layout_constraintLeft_toLeftOf, 8);
                a.append(h.f.b.g.ConstraintLayout_Layout_layout_constraintLeft_toRightOf, 9);
                a.append(h.f.b.g.ConstraintLayout_Layout_layout_constraintRight_toLeftOf, 10);
                a.append(h.f.b.g.ConstraintLayout_Layout_layout_constraintRight_toRightOf, 11);
                a.append(h.f.b.g.ConstraintLayout_Layout_layout_constraintTop_toTopOf, 12);
                a.append(h.f.b.g.ConstraintLayout_Layout_layout_constraintTop_toBottomOf, 13);
                a.append(h.f.b.g.ConstraintLayout_Layout_layout_constraintBottom_toTopOf, 14);
                a.append(h.f.b.g.ConstraintLayout_Layout_layout_constraintBottom_toBottomOf, 15);
                a.append(h.f.b.g.ConstraintLayout_Layout_layout_constraintBaseline_toBaselineOf, 16);
                a.append(h.f.b.g.ConstraintLayout_Layout_layout_constraintCircle, 2);
                a.append(h.f.b.g.ConstraintLayout_Layout_layout_constraintCircleRadius, 3);
                a.append(h.f.b.g.ConstraintLayout_Layout_layout_constraintCircleAngle, 4);
                a.append(h.f.b.g.ConstraintLayout_Layout_layout_editor_absoluteX, 49);
                a.append(h.f.b.g.ConstraintLayout_Layout_layout_editor_absoluteY, 50);
                a.append(h.f.b.g.ConstraintLayout_Layout_layout_constraintGuide_begin, 5);
                a.append(h.f.b.g.ConstraintLayout_Layout_layout_constraintGuide_end, 6);
                a.append(h.f.b.g.ConstraintLayout_Layout_layout_constraintGuide_percent, 7);
                a.append(h.f.b.g.ConstraintLayout_Layout_android_orientation, 1);
                a.append(h.f.b.g.ConstraintLayout_Layout_layout_constraintStart_toEndOf, 17);
                a.append(h.f.b.g.ConstraintLayout_Layout_layout_constraintStart_toStartOf, 18);
                a.append(h.f.b.g.ConstraintLayout_Layout_layout_constraintEnd_toStartOf, 19);
                a.append(h.f.b.g.ConstraintLayout_Layout_layout_constraintEnd_toEndOf, 20);
                a.append(h.f.b.g.ConstraintLayout_Layout_layout_goneMarginLeft, 21);
                a.append(h.f.b.g.ConstraintLayout_Layout_layout_goneMarginTop, 22);
                a.append(h.f.b.g.ConstraintLayout_Layout_layout_goneMarginRight, 23);
                a.append(h.f.b.g.ConstraintLayout_Layout_layout_goneMarginBottom, 24);
                a.append(h.f.b.g.ConstraintLayout_Layout_layout_goneMarginStart, 25);
                a.append(h.f.b.g.ConstraintLayout_Layout_layout_goneMarginEnd, 26);
                a.append(h.f.b.g.ConstraintLayout_Layout_layout_constraintHorizontal_bias, 29);
                a.append(h.f.b.g.ConstraintLayout_Layout_layout_constraintVertical_bias, 30);
                a.append(h.f.b.g.ConstraintLayout_Layout_layout_constraintDimensionRatio, 44);
                a.append(h.f.b.g.ConstraintLayout_Layout_layout_constraintHorizontal_weight, 45);
                a.append(h.f.b.g.ConstraintLayout_Layout_layout_constraintVertical_weight, 46);
                a.append(h.f.b.g.ConstraintLayout_Layout_layout_constraintHorizontal_chainStyle, 47);
                a.append(h.f.b.g.ConstraintLayout_Layout_layout_constraintVertical_chainStyle, 48);
                a.append(h.f.b.g.ConstraintLayout_Layout_layout_constrainedWidth, 27);
                a.append(h.f.b.g.ConstraintLayout_Layout_layout_constrainedHeight, 28);
                a.append(h.f.b.g.ConstraintLayout_Layout_layout_constraintWidth_default, 31);
                a.append(h.f.b.g.ConstraintLayout_Layout_layout_constraintHeight_default, 32);
                a.append(h.f.b.g.ConstraintLayout_Layout_layout_constraintWidth_min, 33);
                a.append(h.f.b.g.ConstraintLayout_Layout_layout_constraintWidth_max, 34);
                a.append(h.f.b.g.ConstraintLayout_Layout_layout_constraintWidth_percent, 35);
                a.append(h.f.b.g.ConstraintLayout_Layout_layout_constraintHeight_min, 36);
                a.append(h.f.b.g.ConstraintLayout_Layout_layout_constraintHeight_max, 37);
                a.append(h.f.b.g.ConstraintLayout_Layout_layout_constraintHeight_percent, 38);
                a.append(h.f.b.g.ConstraintLayout_Layout_layout_constraintLeft_creator, 39);
                a.append(h.f.b.g.ConstraintLayout_Layout_layout_constraintTop_creator, 40);
                a.append(h.f.b.g.ConstraintLayout_Layout_layout_constraintRight_creator, 41);
                a.append(h.f.b.g.ConstraintLayout_Layout_layout_constraintBottom_creator, 42);
                a.append(h.f.b.g.ConstraintLayout_Layout_layout_constraintBaseline_creator, 43);
            }
        }
        ...
        public a(Context context, AttributeSet attributeSet) {
            super(context, attributeSet);
            int i2;
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, h.f.b.g.ConstraintLayout_Layout);
            int indexCount = obtainStyledAttributes.getIndexCount();
            for (int i3 = 0; i3 < indexCount; i3++) {
                ...
                switch (i4) {
                    case 1:
                        ...
                        break;
                    case 2:
                        int resourceId = obtainStyledAttributes.getResourceId(index, this.f177m);
                        this.f177m = resourceId;
                        if (resourceId != -1) {
                            break;
                        } else {
                            this.f177m = obtainStyledAttributes.getInt(index, -1);
                            break;
                        }
                    case 3:
                        this.f178n = obtainStyledAttributes.getDimensionPixelSize(index, this.f178n);
                        break;
                    case 4:
                        float f2 = obtainStyledAttributes.getFloat(index, this.f179o) % 360.0f;
                        this.f179o = f2;
                        if (f2 >= 0.0f) {
                            break;
                        } else {
                            this.f179o = (360.0f - f2) % 360.0f;
                            break;
                        }
                    case 5:
                        ...
                        break;
                    case 6:
                        this.f169b = obtainStyledAttributes.getDimensionPixelOffset(index, this.f169b);
                        break;
                    case 7:
                    ...
                    case 10:
                        int resourceId4 = obtainStyledAttributes.getResourceId(index, this.f170f);
                        this.f170f = resourceId4;
                        if (resourceId4 != -1) {
                            break;
                        } else {
                            this.f170f = obtainStyledAttributes.getInt(index, -1);
                            break;
                        }
                    case 11:
                        int resourceId5 = obtainStyledAttributes.getResourceId(index, this.f171g);
                        this.f171g = resourceId5;
                        if (resourceId5 != -1) {
                            break;
                        } else {
                            this.f171g = obtainStyledAttributes.getInt(index, -1);
                            break;
                        }
                    case 12:
                        int resourceId6 = obtainStyledAttributes.getResourceId(index, this.f172h);
                        this.f172h = resourceId6;
                        if (resourceId6 != -1) {
                            break;
                        } else {
                            this.f172h = obtainStyledAttributes.getInt(index, -1);
                            break;
                        }
                    case 13:
                        int resourceId7 = obtainStyledAttributes.getResourceId(index, this.f173i);
                        this.f173i = resourceId7;
                        if (resourceId7 != -1) {
                            break;
                        } else {
                            this.f173i = obtainStyledAttributes.getInt(index, -1);
                            break;
                        }
                    case 14:
                        int resourceId8 = obtainStyledAttributes.getResourceId(index, this.f174j);
                        this.f174j = resourceId8;
                        if (resourceId8 != -1) {
                            break;
                        } else {
                            this.f174j = obtainStyledAttributes.getInt(index, -1);
                            break;
                        }
                    case 15:
                    ...
                    case 16:
                        int resourceId10 = obtainStyledAttributes.getResourceId(index, this.f176l);
                        this.f176l = resourceId10;
                        if (resourceId10 != -1) {
                            break;
                        } else {
                            this.f176l = obtainStyledAttributes.getInt(index, -1);
                            break;
                        }
                    case 17:
                        int resourceId11 = obtainStyledAttributes.getResourceId(index, this.f180p);
                        this.f180p = resourceId11;
                        if (resourceId11 != -1) {
                            break;
                        } else {
                            this.f180p = obtainStyledAttributes.getInt(index, -1);
                            break;
                        }
                    case 18:
                        int resourceId12 = obtainStyledAttributes.getResourceId(index, this.f181q);
                        this.f181q = resourceId12;
                        if (resourceId12 != -1) {
                            break;
                        } else {
                            this.f181q = obtainStyledAttributes.getInt(index, -1);
                            break;
                        }
                    case 19:
        ...
        public void a() {
            ...
            if (this.c != -1.0f || this.a != -1 || this.f169b != -1) {
                this.X = true;
                this.U = true;
                this.V = true;
