...
public final class g0 extends k<g0, b> implements j0 {

    /* renamed from: j  reason: collision with root package name */
    public static final g0 f4456j;

    /* renamed from: k  reason: collision with root package name */
    public static volatile q<g0> f4457k;

    /* renamed from: h  reason: collision with root package name */
    public int f4458h;

    /* renamed from: i  reason: collision with root package name */
    public f f4459i = f.f4932f;
    ...
    public static /* synthetic */ class a {
        ...
        static {
            ...
            L_0x0041:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: i.c.c.a.z.g0.a.<clinit>():void");
        }
    }
    ...
    public static /* synthetic */ void a(g0 g0Var, f fVar) {
        if (fVar != null) {
            g0Var.f4459i = fVar;
            return;
        }
    ...
    public int c() {
        ...
        if (!this.f4459i.isEmpty()) {
            i3 += CodedOutputStream.b(2, this.f4459i);
        }
        this.f4950g = i3;
        return i3;
    }
    ...
    /* compiled from: AesSivKey */
    public static final class b extends k.b<g0, b> implements j0 {
        public b() {
            super(g0.f4456j);
        }
    ...
    public void a(CodedOutputStream codedOutputStream) {
        ...
        if (!this.f4459i.isEmpty()) {
            codedOutputStream.a(2, this.f4459i);
        }
    }
    ...
    public final Object a(k.j jVar, Object obj, Object obj2) {
        ...
        switch (jVar.ordinal()) {
            ...
            case 1:
                ...
                g0 g0Var = (g0) obj2;
                this.f4458h = kVar.a(this.f4458h != 0, this.f4458h, g0Var.f4458h != 0, g0Var.f4458h);
                boolean z2 = this.f4459i != f.f4932f;
                f fVar = this.f4459i;
                if (g0Var.f4459i != f.f4932f) {
                    z = true;
                }
                this.f4459i = kVar.a(z2, fVar, z, g0Var.f4459i);
                return this;
            case 2:
                g gVar = (g) obj;
                i iVar = (i) obj2;
