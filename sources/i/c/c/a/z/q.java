...
public final class q extends k<q, b> implements t {

    /* renamed from: k  reason: collision with root package name */
    public static final q f4551k;

    /* renamed from: l  reason: collision with root package name */
    public static volatile i.c.f.q<q> f4552l;
    ...
    public static /* synthetic */ class a {
        ...
        static {
            ...
            L_0x0041:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: i.c.c.a.z.q.a.<clinit>():void");
        }
    }
    ...
    public int c() {
        ...
        if (!this.f4555j.isEmpty()) {
            i3 += CodedOutputStream.b(3, this.f4555j);
        }
        this.f4950g = i3;
        return i3;
    }
    ...
    /* compiled from: AesEaxKey */
    public static final class b extends k.b<q, b> implements t {
        public b() {
            super(q.f4551k);
        }
    ...
    public void a(CodedOutputStream codedOutputStream) {
        ...
        if (!this.f4555j.isEmpty()) {
            codedOutputStream.a(3, this.f4555j);
        }
    }
    ...
    public final Object a(k.j jVar, Object obj, Object obj2) {
        ...
        switch (jVar.ordinal()) {
            ...
            case 1:
                ...
                q qVar = (q) obj2;
                this.f4553h = kVar.a(this.f4553h != 0, this.f4553h, qVar.f4553h != 0, qVar.f4553h);
                this.f4554i = (u) kVar.a(this.f4554i, qVar.f4554i);
                boolean z2 = this.f4555j != f.f4932f;
                f fVar = this.f4555j;
                if (qVar.f4555j != f.f4932f) {
                    z = true;
                }
                this.f4555j = kVar.a(z2, fVar, z, qVar.f4555j);
                return this;
            case 2:
                g gVar = (g) obj;
                i iVar = (i) obj2;
                    ...
                    try {
                        ...
                        if (i2 != 0) {
                            if (i2 == 8) {
                                ...
                                u.b bVar = this.f4554i != null ? (u.b) this.f4554i.e() : null;
                                u uVar = (u) gVar.a(u.f4585i.g(), iVar);
                                this.f4554i = uVar;
                                if (bVar != null) {
                                    bVar.a(uVar);
                                    this.f4554i = (u) bVar.j();
                                }
                            } else if (i2 == 26) {
                                this.f4555j = gVar.a();
                            } else if (!gVar.e(i2)) {
