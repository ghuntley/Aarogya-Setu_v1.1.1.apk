...
public final class l extends k<l, b> implements m {

    /* renamed from: j  reason: collision with root package name */
    public static final l f4499j;

    /* renamed from: k  reason: collision with root package name */
    public static volatile q<l> f4500k;
    ...
    public static /* synthetic */ class a {
        ...
        static {
            ...
            L_0x0041:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: i.c.c.a.z.l.a.<clinit>():void");
        }
    }
    ...
    public final Object a(k.j jVar, Object obj, Object obj2) {
        ...
        switch (jVar.ordinal()) {
            ...
            case 1:
                ...
                l lVar = (l) obj2;
                this.f4501h = (o) kVar.a(this.f4501h, lVar.f4501h);
                boolean z2 = this.f4502i != 0;
                int i2 = this.f4502i;
                if (lVar.f4502i != 0) {
                    z = true;
                }
                this.f4502i = kVar.a(z2, i2, z, lVar.f4502i);
                return this;
            case 2:
                g gVar = (g) obj;
                i iVar = (i) obj2;
                while (!z) {
                    try {
                        ...
                        if (i3 != 0) {
                            if (i3 == 10) {
                                o.b bVar = this.f4501h != null ? (o.b) this.f4501h.e() : null;
                                o oVar = (o) gVar.a(o.f4530i.g(), iVar);
                                this.f4501h = oVar;
                                if (bVar != null) {
                                    bVar.a(oVar);
                                    this.f4501h = (o) bVar.j();
                                }
                            } else if (i3 == 16) {
                                this.f4502i = gVar.d();
                            } else if (!gVar.e(i3)) {
