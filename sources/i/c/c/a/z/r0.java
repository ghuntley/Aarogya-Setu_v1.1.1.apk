...
public final class r0 extends k<r0, b> implements s0 {

    /* renamed from: k  reason: collision with root package name */
    public static final r0 f4570k;

    /* renamed from: l  reason: collision with root package name */
    public static volatile q<r0> f4571l;
    ...
    public static /* synthetic */ class a {
        ...
        static {
            ...
            L_0x0041:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: i.c.c.a.z.r0.a.<clinit>():void");
        }
    }
    ...
    public static /* synthetic */ void a(r0 r0Var, t0 t0Var) {
        if (t0Var != null) {
            r0Var.f4573i = t0Var;
            return;
        }
    ...
    public int c() {
        ...
        if (!this.f4574j.isEmpty()) {
            i3 += CodedOutputStream.b(3, this.f4574j);
        }
        this.f4950g = i3;
        return i3;
    }
    ...
    public t0 i() {
        t0 t0Var = this.f4573i;
        return t0Var == null ? t0.f4579l : t0Var;
    }

    /* compiled from: EcdsaPrivateKey */
    public static final class b extends k.b<r0, b> implements s0 {
        public b() {
            super(r0.f4570k);
        }
    ...
    public static /* synthetic */ void a(r0 r0Var, f fVar) {
        if (fVar != null) {
            r0Var.f4574j = fVar;
            return;
        }
    ...
    public void a(CodedOutputStream codedOutputStream) {
        ...
        if (!this.f4574j.isEmpty()) {
            codedOutputStream.a(3, this.f4574j);
        }
    }
    ...
    public final Object a(k.j jVar, Object obj, Object obj2) {
        ...
        switch (jVar.ordinal()) {
            ...
            case 1:
                ...
                r0 r0Var = (r0) obj2;
                this.f4572h = kVar.a(this.f4572h != 0, this.f4572h, r0Var.f4572h != 0, r0Var.f4572h);
                this.f4573i = (t0) kVar.a(this.f4573i, r0Var.f4573i);
                boolean z2 = this.f4574j != f.f4932f;
                f fVar = this.f4574j;
                if (r0Var.f4574j != f.f4932f) {
                    z = true;
                }
                this.f4574j = kVar.a(z2, fVar, z, r0Var.f4574j);
                return this;
            case 2:
                g gVar = (g) obj;
                i iVar = (i) obj2;
                    ...
                    try {
                        ...
                        if (i2 != 0) {
                            if (i2 == 8) {
                                ...
                                t0.b bVar = this.f4573i != null ? (t0.b) this.f4573i.e() : null;
                                t0 t0Var = (t0) gVar.a(t0.f4579l.g(), iVar);
                                this.f4573i = t0Var;
                                if (bVar != null) {
                                    bVar.a(t0Var);
                                    this.f4573i = (t0) bVar.j();
                                }
                            } else if (i2 == 26) {
                                this.f4574j = gVar.a();
                            } else if (!gVar.e(i2)) {
