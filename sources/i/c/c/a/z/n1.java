...
public final class n1 extends k<n1, b> implements o1 {

    /* renamed from: j  reason: collision with root package name */
    public static final n1 f4526j;

    /* renamed from: k  reason: collision with root package name */
    public static volatile q<n1> f4527k;

    /* renamed from: h  reason: collision with root package name */
    public f f4528h = f.f4932f;
    ...
    public static /* synthetic */ class a {
        ...
        static {
            ...
            L_0x0041:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: i.c.c.a.z.n1.a.<clinit>():void");
        }
    }
    ...
    public static /* synthetic */ void a(n1 n1Var, f fVar) {
        if (fVar != null) {
            n1Var.f4528h = fVar;
            return;
        }
    ...
    public int c() {
        ...
        if (!this.f4528h.isEmpty()) {
            i3 = 0 + CodedOutputStream.b(2, this.f4528h);
        }
        e2 e2Var = this.f4529i;
        if (e2Var != null) {
            i3 += CodedOutputStream.b(3, (o) e2Var);
        }
        this.f4950g = i3;
        return i3;
    }
    ...
    /* compiled from: EncryptedKeyset */
    public static final class b extends k.b<n1, b> implements o1 {
        public b() {
            super(n1.f4526j);
        }
    ...
    public static /* synthetic */ void a(n1 n1Var, e2 e2Var) {
        if (e2Var != null) {
            n1Var.f4529i = e2Var;
            return;
        }
    ...
    public void a(CodedOutputStream codedOutputStream) {
        if (!this.f4528h.isEmpty()) {
            codedOutputStream.a(2, this.f4528h);
        }
        e2 e2Var = this.f4529i;
        if (e2Var != null) {
            codedOutputStream.a(3, (o) e2Var);
        }
    }
    ...
    public final Object a(k.j jVar, Object obj, Object obj2) {
        ...
        switch (jVar.ordinal()) {
            ...
            case 1:
                ...
                n1 n1Var = (n1) obj2;
                boolean z2 = this.f4528h != f.f4932f;
                f fVar = this.f4528h;
                if (n1Var.f4528h != f.f4932f) {
                    z = true;
                }
                this.f4528h = kVar.a(z2, fVar, z, n1Var.f4528h);
                this.f4529i = (e2) kVar.a(this.f4529i, n1Var.f4529i);
                return this;
            case 2:
                g gVar = (g) obj;
                i iVar = (i) obj2;
                    ...
                    try {
                        ...
                        if (i2 != 0) {
                            if (i2 == 18) {
                                ...
                                e2.b bVar = this.f4529i != null ? (e2.b) this.f4529i.e() : null;
                                e2 e2Var = (e2) gVar.a(e2.f4441k.g(), iVar);
                                this.f4529i = e2Var;
                                if (bVar != null) {
                                    bVar.a(e2Var);
                                    this.f4529i = (e2) bVar.j();
                                }
                            } else if (!gVar.e(i2)) {
                            }
                        }
