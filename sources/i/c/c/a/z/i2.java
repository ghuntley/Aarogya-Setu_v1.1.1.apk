...
public final class i2 extends k<i2, b> implements j2 {

    /* renamed from: i  reason: collision with root package name */
    public static final i2 f4483i;

    /* renamed from: j  reason: collision with root package name */
    public static volatile q<i2> f4484j;
    ...
    public static /* synthetic */ class a {
        ...
        static {
            ...
            L_0x0041:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: i.c.c.a.z.i2.a.<clinit>():void");
        }
    }
    ...
    public void a(CodedOutputStream codedOutputStream) {
        if (!this.f4485h.isEmpty()) {
            codedOutputStream.a(1, this.f4485h);
        }
    }
    ...
    public int c() {
        ...
        int i3 = 0;
        if (!this.f4485h.isEmpty()) {
            i3 = 0 + CodedOutputStream.b(1, this.f4485h);
        }
        this.f4950g = i3;
        return i3;
    }
    ...
    /* compiled from: KmsAeadKeyFormat */
    public static final class b extends k.b<i2, b> implements j2 {
        public b() {
            super(i2.f4483i);
        }
    ...
    public final Object a(k.j jVar, Object obj, Object obj2) {
        switch (jVar.ordinal()) {
            ...
            case 1:
                i2 i2Var = (i2) obj2;
                this.f4485h = ((k.C0142k) obj).a(!this.f4485h.isEmpty(), this.f4485h, true ^ i2Var.f4485h.isEmpty(), i2Var.f4485h);
                return this;
            case 2:
                g gVar = (g) obj;
                i iVar = (i) obj2;
