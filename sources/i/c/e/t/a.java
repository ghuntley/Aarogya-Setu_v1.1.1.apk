...
public final class a {
    ...
    /* renamed from: i.c.e.t.a$a  reason: collision with other inner class name */
    /* compiled from: $Gson$Types */
    public static final class C0137a implements GenericArrayType, Serializable {
        public final Type e;
    ...
    public static final class b implements ParameterizedType, Serializable {
        ...
        public final Type f4865f;

        /* renamed from: g  reason: collision with root package name */
        public final Type[] f4866g;
        ...
        public b(Type type, Type type2, Type... typeArr) {
            ...
            this.e = type3;
            this.f4865f = a.a(type2);
            Type[] typeArr2 = (Type[]) typeArr.clone();
            this.f4866g = typeArr2;
            int length = typeArr2.length;
            for (int i2 = 0; i2 < length; i2++) {
                e.a(this.f4866g[i2]);
                a.b(this.f4866g[i2]);
                Type[] typeArr3 = this.f4866g;
        ...
        public int hashCode() {
            int hashCode = Arrays.hashCode(this.f4866g) ^ this.f4865f.hashCode();
            Type type = this.e;
            return hashCode ^ (type != null ? type.hashCode() : 0);
        }

        public String toString() {
            int length = this.f4866g.length;
            if (length == 0) {
                return a.d(this.f4865f);
            }
            StringBuilder sb = new StringBuilder((length + 1) * 30);
            sb.append(a.d(this.f4865f));
            sb.append("<");
            sb.append(a.d(this.f4866g[0]));
            for (int i2 = 1; i2 < length; i2++) {
                sb.append(", ");
                sb.append(a.d(this.f4866g[i2]));
            }
            sb.append(">");
            return sb.toString();
        }
    ...
    public static final class c implements WildcardType, Serializable {
        ...
        /* renamed from: f  reason: collision with root package name */
        public final Type f4867f;

        public c(Type[] typeArr, Type[] typeArr2) {
            Class<Object> cls = Object.class;
            boolean z = true;
            e.a(typeArr2.length <= 1);
            e.a(typeArr.length == 1);
            if (typeArr2.length == 1) {
                e.a(typeArr2[0]);
                a.b(typeArr2[0]);
                e.a(typeArr[0] != cls ? false : z);
                this.f4867f = a.a(typeArr2[0]);
                this.e = cls;
                return;
            }
            e.a(typeArr[0]);
    ...
    public static Type a(Type type) {
        if (type instanceof Class) {
            ...
            return cls.isArray() ? new C0137a(a(cls.getComponentType())) : cls;
        } else if (type instanceof ParameterizedType) {
            ParameterizedType parameterizedType = (ParameterizedType) type;
            return new b(parameterizedType.getOwnerType(), parameterizedType.getRawType(), parameterizedType.getActualTypeArguments());
        } else if (type instanceof GenericArrayType) {
            return new C0137a(((GenericArrayType) type).getGenericComponentType());
        } else {
    ...
    public static void b(Type type) {
        e.a(!(type instanceof Class) || !((Class) type).isPrimitive());
    }
    ...
    public static java.lang.reflect.Type a(java.lang.reflect.Type r8, java.lang.Class<?> r9, java.lang.reflect.Type r10, java.util.Collection<java.lang.reflect.TypeVariable> r11) {
        ...
        L_0x004e:
            ...
            goto L_0x006b
        L_0x0066:
            i.c.e.t.a$a r0 = new i.c.e.t.a$a
            r0.<init>(r8)
        L_0x006b:
            return r0
        L_0x006c:
            ...
            goto L_0x0082
        L_0x007d:
            i.c.e.t.a$a r10 = new i.c.e.t.a$a
            r10.<init>(r8)
        L_0x0082:
            return r10
        L_0x0083:
        ...
        L_0x00b7:
            ...
            i.c.e.t.a$b r10 = new i.c.e.t.a$b
            r10.<init>(r3, r8, r4)
        L_0x00c2:
            return r10
        L_0x00c3:
        ...
        L_0x00e9:
            ...
            r8 = r9
        L_0x00ee:
            i.c.e.t.a$c r9 = new i.c.e.t.a$c
        ...
        L_0x0121:
            return r10
        */
        throw new UnsupportedOperationException("Method not decompiled: i.c.e.t.a.a(java.lang.reflect.Type, java.lang.Class, java.lang.reflect.Type, java.util.Collection):java.lang.reflect.Type");
    }
}
