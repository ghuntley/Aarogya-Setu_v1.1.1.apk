...
public class a {
    ...
    public static java.util.Date a(java.lang.String r17, java.text.ParsePosition r18) {
        ...
        L_0x0213:
            ...
            throw r4
        */
        throw new UnsupportedOperationException("Method not decompiled: i.c.e.t.y.d.a.a(java.lang.String, java.text.ParsePosition):java.util.Date");
    }
    ...
    public static int a(String str, int i2, int i3) {
        ...
        if (i2 < i3) {
            ...
            if (digit >= 0) {
                ...
                StringBuilder a2 = i.a.a.a.a.a("Invalid number: ");
        ...
        while (i5 < i3) {
            ...
            if (digit2 >= 0) {
                ...
                StringBuilder a3 = i.a.a.a.a.a("Invalid number: ");
