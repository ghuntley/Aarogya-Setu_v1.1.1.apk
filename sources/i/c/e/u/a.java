...
public class a<T> {
    ...
    public a() {
        ...
        this.rawType = i.c.e.t.a.c(superclassTypeParameter);
    ...
    public static a<?> getArray(Type type2) {
        return new a<>(new a.C0137a(type2));
    }
    ...
    public static Type getSuperclassTypeParameter(Class<?> cls) {
        ...
        if (!(genericSuperclass instanceof Class)) {
            return i.c.e.t.a.a(((ParameterizedType) genericSuperclass).getActualTypeArguments()[0]);
        }
    ...
    public final boolean equals(Object obj) {
        return (obj instanceof a) && i.c.e.t.a.a(this.type, ((a) obj).type);
    }
    ...
    public boolean isAssignableFrom(Type type2) {
        ...
        if (type3 instanceof Class) {
            return this.rawType.isAssignableFrom(i.c.e.t.a.c(type2));
        }
        ...
        } else if (!this.rawType.isAssignableFrom(i.c.e.t.a.c(type2)) || !isAssignableFrom(type2, (GenericArrayType) this.type)) {
            return false;
        } else {
            return true;
        }
    ...
    public a(Type type2) {
        if (type2 != null) {
            Type a = i.c.e.t.a.a(type2);
            this.type = a;
            this.rawType = i.c.e.t.a.c(a);
            this.hashCode = this.type.hashCode();
            return;
        }
        throw null;
