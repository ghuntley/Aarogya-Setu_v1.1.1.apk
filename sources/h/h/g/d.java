...
public class d extends i {
    ...
    public static Class<?> f1757b = null;
    public static Constructor<?> c = null;
    public static Method d = null;
    public static Method e = null;

    /* renamed from: f  reason: collision with root package name */
    public static boolean f1758f = false;
    ...
    public Typeface a(Context context, c cVar, Resources resources, int i2) {
        ...
        try {
            ...
            h.h.f.b.d[] dVarArr = cVar.a;
            int length = dVarArr.length;
            int i3 = 0;
            while (i3 < length) {
                h.h.f.b.d dVar = dVarArr[i3];
                File a = a.a(context);
                if (a == null) {
                    return null;
                }
                try {
                    if (!a.a(a, resources, dVar.f1749f)) {
                        a.delete();
                        return null;
                    } else if (!a((Object) newInstance, a.getPath(), dVar.f1748b, dVar.c)) {
                        return null;
                    } else {
                        a.delete();
                        i3++;
            ...
            a();
            try {
                Object newInstance2 = Array.newInstance(f1757b, 1);
    ...
    public android.graphics.Typeface a(android.content.Context r4, android.os.CancellationSignal r5, h.h.j.b.f[] r6, int r7) {
        /*
            r3 = this;
            int r0 = r6.length
            r1 = 0
            ...
            return r1
        L_0x0006:
            h.h.j.b$f r6 = r3.a((h.h.j.b.f[]) r6, (int) r7)
        ...
        L_0x0087:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: h.h.g.d.a(android.content.Context, android.os.CancellationSignal, h.h.j.b$f[], int):android.graphics.Typeface");
    }
}
