...
public class h extends i {
    ...
    public android.graphics.Typeface a(android.content.Context r11, android.os.CancellationSignal r12, h.h.j.b.f[] r13, int r14) {
        /*
            r10 = this;
        ...
        L_0x002f:
            ...
            int r6 = r6.f1784b     // Catch:{ all -> 0x004a }
        ...
        L_0x006c:
            ...
            return r11
        */
        throw new UnsupportedOperationException("Method not decompiled: h.h.g.h.a(android.content.Context, android.os.CancellationSignal, h.h.j.b$f[], int):android.graphics.Typeface");
    }
    ...
    public Typeface a(Context context, c cVar, Resources resources, int i2) {
        ...
        while (true) {
            ...
            d dVar = dVarArr[i4];
            try {
                Font.Builder weight = new Font.Builder(resources, dVar.f1749f).setWeight(dVar.f1748b);
                if (!dVar.c) {
                    i5 = 0;
                }
                Font build = weight.setSlant(i5).setTtcIndex(dVar.e).setFontVariationSettings(dVar.d).build();
                if (builder == null) {
