...
public class f extends d {
    ...
    public final Constructor<?> f1761h;

    /* renamed from: i  reason: collision with root package name */
    public final Method f1762i;

    /* renamed from: j  reason: collision with root package name */
    public final Method f1763j;

    /* renamed from: k  reason: collision with root package name */
    public final Method f1764k;

    /* renamed from: l  reason: collision with root package name */
    public final Method f1765l;

    /* renamed from: m  reason: collision with root package name */
    public final Method f1766m;
    ...
    private Object c() {
        try {
            return this.f1761h.newInstance(new Object[0]);
    ...
    public final boolean a(Context context, Object obj, String str, int i2, int i3, int i4, FontVariationAxis[] fontVariationAxisArr) {
        try {
            return ((Boolean) this.f1762i.invoke(obj, new Object[]{context.getAssets(), str, 0, false, Integer.valueOf(i2), Integer.valueOf(i3), Integer.valueOf(i4), fontVariationAxisArr})).booleanValue();
    ...
    public final boolean b() {
        ...
        return this.f1762i != null;
    }

    public final boolean c(Object obj) {
        try {
            return ((Boolean) this.f1764k.invoke(obj, new Object[0])).booleanValue();
        } catch (IllegalAccessException | InvocationTargetException unused) {
            return false;
        }
    }
    ...
    public Typeface b(Object obj) {
        try {
            Object newInstance = Array.newInstance(this.f1760g, 1);
            Array.set(newInstance, 0, obj);
            return (Typeface) this.f1766m.invoke((Object) null, new Object[]{newInstance, -1, -1});
        } catch (IllegalAccessException | InvocationTargetException unused) {
            return null;
        }
    }
    ...
    public final void a(Object obj) {
        try {
            this.f1765l.invoke(obj, new Object[0]);
        } catch (IllegalAccessException | InvocationTargetException unused) {
        }
    }
    ...
    public Typeface a(Context context, c cVar, Resources resources, int i2) {
        ...
        for (d dVar : cVar.a) {
            if (!a(context, c, dVar.a, dVar.e, dVar.f1748b, dVar.c ? 1 : 0, FontVariationAxis.fromFontVariationSettings(dVar.d))) {
                a(c);
                return null;
            }
        }
    ...
    public android.graphics.Typeface a(android.content.Context r12, android.os.CancellationSignal r13, h.h.j.b.f[] r14, int r15) {
        /*
            r11 = this;
            int r0 = r14.length
            r1 = 1
        ...
        L_0x0006:
            ...
            h.h.j.b$f r14 = r11.a((h.h.j.b.f[]) r14, (int) r15)
        ...
        L_0x004d:
            return r2
        L_0x004e:
            java.util.Map r12 = h.h.j.b.a((android.content.Context) r12, (h.h.j.b.f[]) r14, (android.os.CancellationSignal) r13)
        ...
        L_0x006c:
            ...
            int r8 = r6.c
            boolean r6 = r6.d
            java.lang.reflect.Method r9 = r11.f1763j     // Catch:{ IllegalAccessException | InvocationTargetException -> 0x009b }
            r10 = 5
        ...
        L_0x00ba:
            ...
            return r12
        */
        throw new UnsupportedOperationException("Method not decompiled: h.h.g.f.a(android.content.Context, android.os.CancellationSignal, h.h.j.b$f[], int):android.graphics.Typeface");
    }
